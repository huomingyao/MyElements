...
| 2026-08-02 | 数据裁决：`hcl`/`naoh`/`caoh2` 的 `zone` 由 `[]` 改为 `["camp"]`（营地试剂架可拾取）——11 条配方无一条产出这三者，但 R6/R7/R8 以它们为材料，不补来源演示路径不可达；SPEC-05 §1 同步并记裁决口径，配方仍恰好 11 条 | R6/R7/R8 与「中和喷雾打酸雾怪」演示路径可达性 | P1 |
